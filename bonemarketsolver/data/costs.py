...
class Cost(Enum):
    ...
    # Casing...
    # Using Casing from Parabola, yields 7 CP per Action
    # see https://fallenlondon.wiki/wiki/Find_the_weakness_in_an_opponent%27s_defences
    CASING_CP = ACTION/7

    # Antique Mystery
    # Using:
    # https://fallenlondon.wiki/wiki/Steal_an_Antique_Mystery_from_Feducci
    # with Parabolan Casing
    ANTIQUE_MYSTERY = ACTION + 32*CASING_CP
    ...
    # Using https://fallenlondon.wiki/wiki/Money-Making#Creating_Cartographer.27s_Hoards
    CARTOGRAPHERS_HOARD = 110.035*ACTION
    ...
    # Using https://fallenlondon.wiki/wiki/Ambush_an_Inattentive_Scholar
    COLLATED_RESEARCH = ACTION + 21*CASING_CP/3
    ...
    INCORRUPTIBLE_BISCUITS = 12*HINTERLAND_SCRIP
    ...
    # Knotted Humerus
    # https://fallenlondon.wiki/wiki/Ambush_an_Inattentive_Scholar
    KNOTTED_HUMERUS = ACTION + 21*CASING_CP/2
    ...
    # At Dangerous 292 and Glasswork 12, this takes 7.42 actions
    THORNED_RIBCAGE = 7.42*ACTION
    ...
    # Travel by Railway is the best option
    RUMOUR_OF_THE_UPPER_RIVER = ACTION

    # Jet Black Stinger
    # "Propose a hunting expedition" at Sophia's, 5 at a time
    # D200 challenge, for D295 -> 88% chance
    BLACK_STINGER = (5*RUMOUR_OF_THE_UPPER_RIVER - 15 + 1/.88 * ACTION) / 5
